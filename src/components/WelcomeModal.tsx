    ...
    >
      ...
      >
        ...
        <div style={{ padding: "16px 24px 24px" }}>
          ...
          {/* Headline */}
          <h1 style={{ fontSize: "22px", fontWeight: 800, lineHeight: 1.15, margin: "0 0 12px", letterSpacing: "-0.02em", fontFamily: "var(--font-syne)" }}>
          ...
          {/* Badge umjesto crte */}
          <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "5px 12px", borderRadius: "20px", background: "rgba(0,255,198,0.08)", border: "1px solid rgba(0,255,198,0.2)", marginBottom: "14px" }}>
            <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#00FFC6", flexShrink: 0, boxShadow: "0 0 6px rgba(0,255,198,0.9)" }} />
            <span style={{ fontSize: "10px", fontWeight: 600, color: "#00FFC6", letterSpacing: "0.08em", textTransform: "uppercase" }}>End-to-end encrypted</span>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", marginTop: "10px" }}>
            <p style={{ margin: 0, fontSize: "10px", color: "#9CA3AF", opacity: 0.5, fontFamily: "var(--font-outfit)" }}>
              No accounts · No logs · No traces
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: "4px", opacity: 0.35 }}>
              ...
              <span style={{ fontSize: "10px", fontWeight: 700, color: "#E5E7EB", fontFamily: "var(--font-syne)" }}>Zerra</span>
            </div>
          </div>
        </div>
